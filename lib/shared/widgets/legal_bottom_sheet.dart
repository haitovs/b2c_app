...
class LegalBottomSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LegalBottomSheet> createState() => _LegalBottomSheetState();
}

class _LegalBottomSheetState extends ConsumerState<LegalBottomSheet> {
